...
export const MOCK_SUCCESS_STORIES = [
    {
        id: 'story-001',
        title: 'From Campus to Google: My Journey as a Software Engineer',
        excerpt: 'How I leveraged my university projects and internships to land my dream job at Google, and what I learned along the way.',
        content: 'Detailed story content here...',
        category: 'Career',
        author: { id: MY_PROFILE.id, name: MY_PROFILE.name, avatarUrl: MY_PROFILE.avatarUrl, gradYear: MY_PROFILE.gradYear },
        likes: 245,
        isLiked: false,
        isFeatured: true,
    ...
    {
        id: 'story-002',
        title: 'Building a Fintech Startup That Raised $5M',
        excerpt: 'The challenges, pivots, and victories of building PayEase from a dorm room idea to a funded startup.',
        content: 'Detailed story content here...',
        category: 'Entrepreneurship',
        author: { id: 'alumni-002', name: 'Priya Sharma', avatarUrl: '', gradYear: '2017' },
        likes: 189,
        isLiked: false,
        isFeatured: true,
    ...
    {
        id: 'story-003',
        title: 'My Research Paper at NeurIPS: A PhD Journey',
        excerpt: 'From confused undergrad to publishing at a top-tier ML conference. Here is what the journey taught me.',
        content: 'Detailed story content here...',
        category: 'Research',
        author: { id: 'alumni-003', name: 'Rahul Verma', avatarUrl: '', gradYear: '2019' },
        likes: 156,
        isLiked: false,
        isFeatured: false,
    ...
    {
        id: 'story-004',
        title: 'Designing Swiggy\'s New Checkout Flow',
        excerpt: 'The design thinking process behind improving order completion rates by 23% through UX improvements.',
        content: 'Detailed story content here...',
        category: 'Innovation',
        author: { id: 'alumni-004', name: 'Sneha Reddy', avatarUrl: '', gradYear: '2020' },
        likes: 132,
        isLiked: false,
        isFeatured: false,
    ...
    {
        id: 'story-005',
        title: 'Building Schools in Rural India: My Social Impact Journey',
        excerpt: 'How a weekend volunteering project turned into a non-profit educating 5000+ children.',
        content: 'Detailed story content here...',
        category: 'Social Impact',
        author: { id: 'alumni-005', name: 'Vikram Malhotra', avatarUrl: '', gradYear: '2015' },
        likes: 278,
        isLiked: false,
        isFeatured: true,
    ...
    {
        id: 'story-006',
        title: 'From Civil Engineering to Product Management',
        excerpt: 'A unconventional career switch that opened new horizons and opportunities.',
        content: 'Detailed story content here...',
        category: 'Career',
        author: { id: 'alumni-006', name: 'Alumni Member 6', avatarUrl: '', gradYear: '2016' },
        likes: 98,
        isLiked: false,
        isFeatured: false,
